...
#    shipment_file.file.recreate_versions!
    ...
    params = {:shipment => {:file => blob_data, :branch_code => shipment_file.branch_code, :yardid => shipment_file.yard_id, :ticket_nbr => shipment_file.ticket_number,
      ...
      :camera_group => "Portal", :sys_date_time => shipment_file.created_at, :event_code => event_code_name, :cust_nbr => shipment_file.customer_number, :cust_name => shipment_file.customer_name,
      :hidden => shipment_file.hidden}}
