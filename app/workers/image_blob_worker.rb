...
#    image_file.file.recreate_versions!
    ...
    # Create blob
      ...
      :sys_date_time => image_file.created_at, :event_code => event_code_name, :cust_nbr => image_file.customer_number, :cust_name => image_file.customer_name, :hidden => image_file.hidden,
      :tare_seq_nbr => image_file.tare_seq_nbr, :cmdy_nbr =>  image_file.tare_seq_nbr, :cmdy_name => image_file.commodity_name, :weight => image_file.weight.to_i,
      "VIN" => image_file.vin_number, "TagNbr" => image_file.tag_number, :leadsonline => leads_online_string}}
