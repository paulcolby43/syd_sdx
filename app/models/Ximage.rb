...
#    "#{Image.site.scheme}://#{Image.site.host}:#{Image.site.port}#{self.azure_url}"
#  end
#  
#  def thumbnail_uri
#    "#{Image.site.scheme}://#{Image.site.host}:#{Image.site.port}#{self.thumbnail_url}"
#  end
#  
#  def hidden?
#    self.hidden == '1'
