...
#      @tickets_on_hold_total = @tickets_on_hold['TicketsOnHold'] unless @tickets_on_hold.blank?
      @tickets_on_hold_total = Scoreboard.v2_tickets_on_hold_count
...
#      @paid_tickets_today_count = @paid_tickets_today_data['PaidTickets']
      @paid_tickets_today_count = Scoreboard.v2_paid_tickets_today_count
...
#      @closed_and_held_and_paid_tickets_today = @held_tickets_today + @closed_tickets_today + @paid_tickets_today
      @closed_and_held_and_paid_tickets = Scoreboard.v2_last_10_by_filter
      @last_10_shipments = Scoreboard.v2_last_10_shipments_by_filter
#      
